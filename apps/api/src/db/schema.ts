...
export const cryptoAssets = pgTable("crypto_assets", {
  ...
  priceChangePct1h: numeric("price_change_pct_1h", { precision: 10, scale: 4 }),
  priceChangePct24h: numeric("price_change_pct_24h", {
    precision: 10,
    scale: 4,
  }),
  priceChangePct7d: numeric("price_change_pct_7d", { precision: 10, scale: 4 }),
  ...
  athChangePct: numeric("ath_change_pct", { precision: 10, scale: 4 }),
  athDate: timestamp("ath_date"),
  atlUsd: numeric("atl_usd", { precision: 24, scale: 8 }),
  atlChangePct: numeric("atl_change_pct", { precision: 10, scale: 4 }),
...
export const cryptoSyncRuns = pgTable("crypto_sync_runs", {
  ...
  syncType: varchar("sync_type", { length: 64 })
    .notNull()
    .default("market_dashboard"),
  status: varchar("status", { length: 32 }).notNull(),
  startedAt: timestamp("started_at").notNull(),
  finishedAt: timestamp("finished_at"),
  durationMs: integer("duration_ms"),
  endpointsUsed: jsonb("endpoints_used"),
